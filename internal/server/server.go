...
func (s *Server) routes() {
	...
	s.mux.HandleFunc("POST /api/storage-sources", s.private(s.createStorageSource))
	s.mux.HandleFunc("PATCH /api/storage-sources/{id}", s.private(s.updateStorageSource))
	s.mux.HandleFunc("DELETE /api/storage-sources/{id}", s.private(s.deleteStorageSource))
	...
	s.mux.HandleFunc("GET /api/users", s.private(s.listUsers))
	s.mux.HandleFunc("POST /api/users", s.private(s.createUser))
	s.mux.HandleFunc("PATCH /api/users/{id}", s.private(s.updateUser))
	s.mux.HandleFunc("DELETE /api/users/{id}", s.private(s.deleteUser))
